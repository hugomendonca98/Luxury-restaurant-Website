class LuxuryController{
    ...
    cardHoverStaff(){
        ...
        [...card].forEach((element, index)=>{
            ...
            let el = element.querySelector('.img-staff > .card-staff-social > .icons-staff');
    ...
    openMenu(){
        ...
        document.querySelector('.menu-bar > label').addEventListener('click', event=>{

            switch(menu.className){

                case 'menu block scale-up-ver-top':
    ...
    formValidate(formEl){ // função para validar e pegar valores do formulario de reservar lugares.
                ...
                if(filds.name === "specialrequeriments" && filds.value == ''){
                    ...
                    if(filds.value == ""){
                        ...
                        if(filds.name === "email"){
                            ...
                            let phone = filds.value.toString().replace("(", "").replace(")", "").length;
    ...
    generateCartlist(){
        ...
        this.products.productsInCart.forEach((element, index)=>{
            ...
            li.innerHTML = ` <img class="img-cart-item" src="${element.product.imageUrl}"> ${element.quantity} ${element.product.name} - $${element.product.price * element.quantity}`
    ...
    addToCart(id){
        ...
        if(this.products.productsInCart.length === 0 || this.productsFound(obj.id) === undefined){
